...
public class ChunkGeneratorTypeWorkaround implements InvocationHandler
{
    ...
    public MinersHorizonChunkGenerator createProxy(World w, BiomeSource biomesource, ChunkGeneratorConfig gensettings) {
        return new MinersHorizonChunkGenerator(w, biomesource, gensettings);
    }
