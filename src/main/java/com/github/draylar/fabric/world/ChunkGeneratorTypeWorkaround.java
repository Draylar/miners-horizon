...
public class ChunkGeneratorTypeWorkaround implements InvocationHandler
{
    ...
    public FabricChunkGenerator createProxy(World w, BiomeSource biomesource, ChunkGeneratorConfig gensettings) {
        return new FabricChunkGenerator(w, biomesource, gensettings);
    }
